...
public class SecondPlayerRacketController : MonoBehaviour
{
    private Animator anim;
    private SecondPlayerController player;

    // Start is called before the first frame update
    void Start()
    {
        anim = gameObject.GetComponent<Animator>();
        player = gameObject.GetComponentInParent<SecondPlayerController>();
    }
