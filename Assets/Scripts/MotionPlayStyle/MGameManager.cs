...
public class MGameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        result = resultManager.GetComponent<MResultManager>();
    ...
    private void Judgement()
    {
        if (isNET)
        {
            ...
            if (isSERVE)
            {
                ...
                if (faultCount == 1) { status = "FAULT"; ResetTakeBack(); }
    ...
    private void Restart()
    {
        ...
        enemyController.playerMovePoint.z = 8.0f * whereServe;
        enemyController.playerMovePoint.x = 49.0f;
    ...
    public void GetNextGame()
    {
        ...
        else
        {
            ...
            enemyController.playerMovePoint.z = 8.0f * whereServe;
            enemyController.playerMovePoint.x = 49.0f;
            player.transform.Translate(49 - player.transform.position.x, 0.0f, 8.0f - player.transform.position.z);
    ...
    {
        playerController.takeBackRight = false;
        playerController.takeBackLeft = false;
        enemyController.takeBackRight = false;
        enemyController.takeBackLeft = false;
    }
